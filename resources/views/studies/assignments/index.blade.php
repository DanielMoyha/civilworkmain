                                        ...
                                        <div class="px-4 py-4 sm:px-5">
                                            <div class="flex justify-between">
                                                ...
                                                <div class="flex justify-end gap-2 text-xs mb-1">
                                                    <a href="{{ route('study.assignments.show', [$work->study->id]) }}" class="btn bg-accent dark:bg-success font-medium text-white hover:dark:bg-success-focus focus:dark:bg-success-focus active:dark:bg-success-focus/90 hover:bg-accent-focus focus:bg-accent-focus active:bg-accent-focus/90 px-2.5">
