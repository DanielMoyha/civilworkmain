        ...
        <form>
            ...
            <div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
                <div class="col-span-12 lg:col-span-12">
                    ...
                    <div class="mt-3">
                        <label class="block">
                            <span class="mb">{{ __('Descripción') }}<x-asterisk></x-asterisk></span>
                            <textarea
                                rows="4"
                                name="description"
            ...
            <div class="flex justify-end space-x-2 pt-4">
                {{-- <button
                    wire:click.prevent="update()" class="btn min-w-[7rem] bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">Actualizar</button>
