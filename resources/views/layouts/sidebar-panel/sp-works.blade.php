            ...
            <ul class="flex flex-1 flex-col px-4 font-inter">
                <li x-data="accordionItem('menu-item-3')">
                    ...
                    <ul x-collapse x-show="expanded">
                        <x-link-sidebar :href="route('admin.works.index')">{{ __('Listar Obras') }}</x-link-sidebar>
                        <x-link-sidebar :href="route('admin.works.create')">{{ __('Registrar Nueva Obra') }}</x-link-sidebar>
                    </ul>
                </li>
