...
<x-button.icon-sidebar href="{{ route('supervision.assignments') }}" x-tooltip.placement.right="'Asignaciones'">
...
<!-- tasks -->
{{-- <x-button.icon-sidebar href="{{ route('supervision.tasks') }}" x-tooltip.placement.right="'Tareas'">
...
<!-- follow-ups -->
<x-button.icon-sidebar href="{{ route('supervision.followups') }}" x-tooltip.placement.right="'Seguimientos'">
