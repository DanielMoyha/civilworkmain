...
<!-- User and Roles -->
<x-button.icon-sidebar href="{{ route('admin.users.index') }}" x-tooltip.placement.right="'Usuarios y Roles'">
...
<!-- Works -->
<x-button.icon-sidebar href="{{ route('admin.works.index') }}" x-tooltip.placement.right="'Obras'">
...
<!-- Services -->
<x-button.icon-sidebar href="{{ route('admin.services.index') }}" x-tooltip.placement.right="'Servicios'">
    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="512.000000pt" height="512.000000pt" fill="none"
...
<!-- Construcions -->
<x-button.icon-sidebar href="{{ route('admin.construction.index') }}" x-tooltip.placement.right="'Área de Construcción'">
...
<!-- Studies -->
<x-button.icon-sidebar href="{{ route('admin.supervision.index') }}" x-tooltip.placement.right="'Área de Supervisión'">
...
<!-- Supervisions -->
<x-button.icon-sidebar href="{{ route('admin.study.index') }}" x-tooltip.placement.right="'Área de Estudios'">
