...
<x-main>
                ...
                <div class="mt-4 grid grid-cols-12 gap-4 px-[var(--margin-x)] transition-all duration-[.25s] sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
                        ...
                        <figure class="highcharts-figure">
                            <div class="pb-2 flex justify-end gap-2">
                                <button class="btn rounded-full bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90" id="plain">
                                    <i class="fa-solid fa-chart-simple"></i><span class="px-1">{{ __('Plano') }}</span>
                                </button>
                                <button class="btn rounded-full bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90" id="inverted">
                                    <i class="fa-solid fa-chart-bar"></i><span class="px-1">{{ __('Invertido') }}</span>
                                </button>
                                <button class="btn rounded-full bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90" id="polar">
                                    <i class="fa-solid fa-chart-line"></i><span class="px-1">{{ __('Polar') }}</span>
                                </button>
                            </div>
                            <div id="container3" class="rounded-md shadow-lg"></div>
                            <p class="highcharts-description mt-2.5">
                                {{ __('Reporte de la realización de Obras civiles en general, en el conteo incluyen las áreas de Construcción, Estudios y Supervisión. Se los puede ver de tres formas diferentes, los cuáles son, gráfico plano en columnas, gráfico de columnas invertido y el gráfico polar.') }}
                            </p>
                        </figure>
                    </div>
                    <div class="col-span-12 lg:col-span-3">
                        <div class="grid grid-cols-1 gap-3 sm:grid-cols-3 sm:gap-5 lg:grid-cols-1">
                            <a href="{{ route('admin.works.index') }}" class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700">
                                <div class="flex justify-between space-x-1">
                                    <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">{{ $totalWorks->count() }}</p>
                                    <svg
                                ...
                                <p class="mt-1 text-xs+">{{ __('Total Obras Civiles') }}</p>
                            </a>
                            <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700">
                                ...
                                <p class="mt-1 text-xs+">{{ __('Obras en Ejecución') }}</p>
                            </div>
                            <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700">
                                <div class="flex justify-between">
                                    <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">
                                ...
                                <p class="mt-1 text-xs+">{{ __('Obras en Pausa') }}</p>
                            </div>
                            <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700">
                                <div class="flex justify-between">
                                    <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">
                                ...
                                <p class="mt-1 text-xs+">{{ __('Obras Concluidas') }}</p>
                            </div>
                            <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700">
                                <div class="flex justify-between">
                                    <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">{{ $deregistering_works->count() }}</p>
                                    <i class="fa-solid fa-ban text-xl text-error"></i>
                                </div>
                                <p class="mt-1 text-xs+">{{ __('Obras dadas de Baja') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-12 lg:col-span-6">
                        <div class="card shadow-lg w-full">
                            <figure class="highcharts-figure p-5">
                                ...
                                <p class="highcharts-description mt-2.5">
                                    {{ __('Los gráficos circulares de radio variable pueden utilizarse para visualizar una segunda dimensión en un gráfico circular. En este gráfico, los departamentos con más obras realizadas se dibujan más alejados, mientras que la anchura del corte viene determinada por el tamaño de cada departamento.') }}
                                </p>
                            </figure>
                        </div>
                    </div>
                    <div class="col-span-12 lg:col-span-6">
                        <div class="card shadow-lg w-full">
                            <figure class="highcharts-figure p-5">
                                ...
                                <p class="highcharts-description mt-2.5">
                                    {{ __('Gráfico de barras con columnas horizontales. Este tipo de gráfico muestra la cantidad de obras ejecutadas por cada departamento de Bolivia.') }}
                                </p>
                            </figure>
                        </div>
                    </div>
                    <div class="col-span-12 lg:col-span-3">
                        <div class="grid grid-cols-1 gap-3 sm:grid-cols-3 sm:gap-5 lg:grid-cols-1">
                            ...
                            <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700">
                                <div class="flex justify-between">
                                    <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">{{ $constructions->count() }}</p>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        viewBox="0 0 24 24"
                            ...
                            <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700">
                                <div class="flex justify-between">
                                    <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">{{ $studies->count() }}</p>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        viewBox="0 0 24 24"
                            ...
                            <div class="rounded-lg bg-slate-150 p-4 dark:bg-navy-700">
                                <div class="flex justify-between">
                                    <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">{{ $supervisions->count() }}</p>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="col-span-12 lg:col-span-9">
                        <figure class="highcharts-figure">
                            ...
                            <p class="highcharts-description mt-2.5">
                                {{ __('Gráfico de barras horizontales apiladas. Este tipo de visualización es ideal para comparar datos que se acumulan hasta alcanzar una suma, que es el caso de los diferentes tipos de obras realizados en cada departamento.') }}
                            </p>
                        </figure>
                    </div>
                </div>
    ...
    @push('scripts')
        ...
        <script>
            var works = {{ Js::from($works) }};
            var states = {{ Js::from($states) }};
            var statesTwo = {{ Js::from($statesTwo) }};
            var consDep = {{ Js::from($consDep) }};
            var stuDep = {{ Js::from($stuDep) }};
            var supDep = {{ Js::from($supDep) }};
