    ...
    <form wire:submit.prevent="submit">
        ...
        <label class="gap-4 grid grid-cols-1 sm:grid-cols-12 my-3">
            <div class="sm:col-span-4">
                <span>{{ __('Nombre de la Tarea') }}</span>
            ...
            <div class="flex items-end sm:col-span-2">
                <button type="submit" class="btn bg-info font-medium text-white hover:bg-info-focus focus:bg-info-focus active:bg-info-focus/90 ">{{ __('Agregar') }}</button>
            </div>
        </label>
        <div>
