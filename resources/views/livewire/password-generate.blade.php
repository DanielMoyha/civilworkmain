<div>
    ...
    {{-- <x-form.input>
        <x-slot:label>{{ __('Contraseña') }}<x-asterisk></x-asterisk></x-slot:label>
        <div class="flex items-center justify-between space-x-2">
            ...
            <button type="button" @class(['inset-y-0 pr-3 flex items-center', 'hidden' => $visible,]) wire:click="$toggle('visible')">
    ...
    <label class="block">
        ...
        <div class="flex items-center justify-between space-x-2">
            <input id="password" name="password"
                ...
                placeholder="Escriba la contraseña" type="{{ $visible ? 'text' : 'password' }}" wire:model="password" />
                

            <button type="button" @class([
                'inset-y-0 pr-3 flex items-center',
                'hidden' => $visible,
