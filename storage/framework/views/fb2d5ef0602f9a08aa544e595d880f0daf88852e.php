...
<?php $component->withAttributes([]); ?>
    ...
    <?php $__env->startSection('content'); ?>
        <?php if(session('status') === 'type-studies-action'): ?>
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        <div class="flex items-center space-x-4 py-5 lg:py-6">
            <h2 class="text-xl font-medium text-slate-800 dark:text-navy-50 lg:text-2xl"><?php echo e(__('Estudios Extras')); ?></h2>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                <li><?php echo e(__('Definición de nuevos estudios extras')); ?></li>
            </ul>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-1">
            <div class="card p-5">
                <div class="lg:flex lg:items-center lg:justify-between lg:text-right text-xs">
                    ...
                    <div class="lg:shrink-0 md:my-1 md:text-left sm:text-center space-y-1.5">
                        <a href="<?php echo e(route('study.studies.upload.documents', [$study->id])); ?>" class="btn bg-info font-medium text-white hover:bg-info-focus focus:bg-info-focus active:bg-info-focus/90">
                            <i class="fa-regular fa-folder-open mr-2"></i><?php echo e(__('Subir Documentos')); ?>
            ...
            <div>
                <div class="card p-5">
                    ...
                    <?php else: ?>
                        <form
                            action="<?php echo e(route('study.assignments.update', $study->id)); ?>"
                            method="POST"
                        ...
                        >
                            ...
                            <label class="block">
                                <span class="font-medium text-slate-600 dark:text-navy-100">
                                    <?php echo e(__('Tipos de Estudio Extra')); ?>
                                ...
                                <select
                                    ...
                                    multiple
                                >
                                    <option value=""><?php echo e(__('Elija los estudios extra...')); ?></option>
                                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typeStudie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($typeStudie->id); ?>" <?php echo e(in_array($typeStudie->id, $studyHasTypeStudies) ? 'selected' : ''); ?> <?php echo e((collect(old('types'))->contains($typeStudie->id)) ? 'selected':''); ?>><?php echo e($typeStudie->name); ?></option>
...
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?><?php /**PATH /var/www/html/resources/views/studies/assignments/show.blade.php ENDPATH**/ ?>