    ...
    <label class="block">
        ...
        <div class="flex items-center justify-between space-x-2">
            <input id="password" name="password"
                ...
                placeholder="Escriba la contraseña" type="<?php echo e($visible ? 'text' : 'password'); ?>" wire:model="password" />
...
<?php /**PATH /var/www/html/resources/views/livewire/password-generate.blade.php ENDPATH**/ ?>