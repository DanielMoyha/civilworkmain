<div>
    <?php if(session('status') === 'type-created'): ?>
    ...
    <?php endif; ?>
    <?php if(session('status') === 'study_type-deleted'): ?>
    ...
    <?php if($updateMode): ?>
        <?php echo $__env->make('studies.type_studies.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php else: ?>
        <?php echo $__env->make('studies.type_studies.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>


    <div class="flex items-center justify-between mt-10">
        <h2 class="text-base font-medium tracking-wide text-slate-700 line-clamp-1 dark:text-navy-100">
            <?php echo e(__('Lista de estudios extra')); ?>
                ...
                <thead>
                    <tr>
                        ...
                        <th
                            ...
                            <?php echo e(__('Nombre del estudio')); ?>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $allTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border border-transparent border-b-slate-200 dark:border-b-navy-500" wire:loading.class='opacity-40 cursor-no-drop'>
                            ...
                            <td class="flex justify-center items-center gap-2 py-2">
                                <button wire:click="edit(<?php echo e($type->id); ?>)" class="btn bg-warning font-medium text-white hover:bg-warning-focus focus:bg-warning-focus active:bg-warning-focus/90 h-8 w-1"><i
                                        class="fa-solid fa-pen-to-square fa-lg"></i></button>
                                <button wire:click="$emit('showAlert', <?php echo e($type->id); ?>)" class="btn bg-error font-medium text-white hover:bg-error-focus focus:bg-error-focus active:bg-error-focus/90 h-8 w-1"><i
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/resources/views/livewire/types-studies-extra.blade.php ENDPATH**/ ?>