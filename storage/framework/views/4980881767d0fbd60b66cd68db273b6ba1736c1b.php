...
<div class="grid place-items-center">
    <div class="card mt-5 w-full max-w-2xl p-4 sm:p-5">
        <p class="font-bold uppercase my-3 text-center text-lg"><?php echo e(__('Registro de Estudios Extras')); ?></p>
        <form>
            <?php echo csrf_field(); ?>
...
</div><?php /**PATH /var/www/html/resources/views/studies/type_studies/create.blade.php ENDPATH**/ ?>