...
} elseif ($_instance->childHasBeenRendered('yXSTF2U')) {
    $componentId = $_instance->getRenderedChildComponentId('yXSTF2U');
    $componentTag = $_instance->getRenderedChildComponentTagName('yXSTF2U');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yXSTF2U');
} else {
    $response = \Livewire\Livewire::mount('user-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('yXSTF2U', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
