...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                <li><?php echo e(__('Lista de asignaciones de estudios de obra')); ?></li>
            </ul>
        </div>
                                ...
                                <div x-data="accordionItem('item-1')" class="overflow-hidden rounded-lg border border-slate-150 dark:border-navy-500">
                                    <div class="flex items-center justify-between bg-slate-150 px-4 py-4 dark:bg-navy-500 sm:px-5">
                                        ...
                                        <?php if($work->completion_date): ?>
                                            <a  href="<?php echo e(route('study.assignments.show', [$work->study->id])); ?>"
                                        ...
                                        <div class="px-4 py-4 sm:px-5">
                                            <div class="flex justify-between">
                                                ...
                                                <div class="flex justify-end gap-2 text-xs mb-1">
                                                    <a href="<?php echo e(route('study.assignments.show', [$work->study->id])); ?>" class="btn bg-accent dark:bg-success font-medium text-white hover:dark:bg-success-focus focus:dark:bg-success-focus active:dark:bg-success-focus/90 hover:bg-accent-focus focus:bg-accent-focus active:bg-accent-focus/90 px-2.5">
...
<?php /**PATH /var/www/html/resources/views/studies/assignments/index.blade.php ENDPATH**/ ?>