                                    ...
                                    <div x-collapse x-show="expanded">
                                        <div class="px-4 py-4 sm:px-5">
                                            ...
                                            <div class="mt-4 flex justify-end gap-2">
                                                <a href="<?php echo e(route('construction.materials', [$work->construction->id])); ?>" class="btn bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90">
