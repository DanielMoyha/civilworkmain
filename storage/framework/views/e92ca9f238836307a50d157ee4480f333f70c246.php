...
<div class="grid place-items-center">
    <div class="card mt-5 w-full max-w-2xl p-4 sm:p-5">
        <p class="font-bold uppercase my-3 text-center text-lg"><?php echo e(__('Registro de Materiales de Construcción')); ?></p>
        <form>
            <?php echo csrf_field(); ?>
...
<?php $component->withAttributes(['class' => 'col-span-2']); ?>
                             <?php $__env->slot('label', null, []); ?> <?php echo e(__('Nombre del Material')); ?><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?> <?php $__env->endSlot(); ?>
                             <?php $__env->slot('input', null, ['class' => 'bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900','placeholder' => 'Escriba el nombre del material de construcción','type' => 'text','name' => 'name','id' => 'name','wire:model' => 'name','value' => ''.e(old('name')).'']); ?>  <?php $__env->endSlot(); ?>
...
<?php endif; ?>
                        ...
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.input-wtc','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('form.input-wtc'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
<?php $component->withAttributes([]); ?>
                             <?php $__env->slot('label', null, []); ?> <?php echo e(__('Cantidad')); ?><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.asterisk','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('asterisk'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?> <?php $__env->endSlot(); ?>
                             <?php $__env->slot('input', null, ['class' => 'onlyNumbers form-input mt-1.5 w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900','placeholder' => 'Digite la cantidad del material que está registrando','type' => 'number','name' => 'quantity','id' => 'quantity','max' => '99999','wire:model' => 'quantity','value' => ''.e(old('quantity')).'']); ?>  <?php $__env->endSlot(); ?>
                             <?php $__env->slot('error', null, []); ?> 
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
</div><?php /**PATH /var/www/html/resources/views/builders/materials/create.blade.php ENDPATH**/ ?>