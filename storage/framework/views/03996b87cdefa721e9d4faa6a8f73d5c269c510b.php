...
} elseif ($_instance->childHasBeenRendered('uouZKbL')) {
    $componentId = $_instance->getRenderedChildComponentId('uouZKbL');
    $componentTag = $_instance->getRenderedChildComponentTagName('uouZKbL');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uouZKbL');
} else {
    $response = \Livewire\Livewire::mount('roles', []);
    $html = $response->html();
    $_instance->logRenderedChild('uouZKbL', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
