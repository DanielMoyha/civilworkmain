...
<?php $component->withAttributes([]); ?>
    <div class="fixed top-0 hidden p-6 lg:block lg:px-12">
        <a href="<?php echo e(route('refresh')); ?>" class="flex items-center space-x-2">
            <img class="h-12 w-12" src="<?php echo e(asset('assets/images/logos/logo-eyserges.svg')); ?>" alt="logo" />
            <p class="text-xl font-semibold uppercase text-slate-700 dark:text-navy-100"><?php echo e(__('EYSERGES')); ?></p>
        </a>
    </div>
    <div class="hidden w-full place-items-center lg:grid">
        <div class="w-full max-w-2xl p-6">
            <img class="w-full" x-show="!$store.global.isDarkModeEnabled" src="<?php echo e(asset('assets/images/5138437.svg')); ?>"
                alt="image" />
            <img class="w-full" x-show="$store.global.isDarkModeEnabled" src="<?php echo e(asset('assets/images/5138437.svg')); ?>"
                alt="image" />
        </div>
    ...
    <main class="flex w-full flex-col items-center bg-white dark:bg-navy-700 lg:max-w-md">
        <div class="flex w-full max-w-sm grow flex-col justify-center p-5">
            <div class="text-center">
                <img class="mx-auto h-16 w-16 lg:hidden" src="<?php echo e(asset('assets/images/logos/logo-eyserges.svg')); ?>" alt="logo" />
                <div class="mt-4">
                    <h2 class="text-2xl font-semibold text-slate-600 dark:text-navy-100"><?php echo e(__('Bienvenido')); ?></h2>
                    <p class="text-slate-400 dark:text-navy-300"><?php echo e(__('Por favor Inicie Sesión para continuar')); ?></p>
                </div>
            </div>
            <!-- Session Status -->
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.auth-session-status','data' => ['class' => 'my-1 text-success','status' => session('status')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'my-1 text-success','status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(session('status'))]); ?>
...
<?php endif; ?>
            <div class="mt-16">
                <form method="POST" action="<?php echo e(route('login')); ?>" id="form" autocomplete="off">
                    <?php echo csrf_field(); ?>
                    <label class="relative flex">
                        <input id="username" name="username" type="text"
                            class="form-input peer w-full rounded-lg bg-slate-150 px-3 py-2 pl-9 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900"
                            value="<?php echo e(old('username')); ?>" placeholder="Nombre de Usuario" required autofocus />
                        <span
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('is_active'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
<?php endif; ?>
                    <div class="mt-4 flex flex-wrap items-center justify-between space-x-2 space-y-3">
                        <label class="inline-flex items-center space-x-2">
                            ...
                            <span class="line-clamp-1"><?php echo e(__('Mantener Sesión Iniciada')); ?></span>
                        </label>
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>"
                                class="text-xs text-slate-400 transition-colors line-clamp-1 hover:text-slate-800 focus:text-slate-800 dark:text-navy-300 dark:hover:text-navy-100 dark:focus:text-navy-100"><?php echo e(__('¿Olvidó su contraseña?')); ?></a>
                        <?php endif; ?>
                    </div>
                    <button
                        type="submit"
        ...
        <div class="my-5 flex justify-center text-xs text-slate-400 dark:text-navy-300">
            <span><?php echo e(__('Derechos Reservados')); ?> &#169;</span>
