...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                    <li><?php echo e(__('Registrar Nuevo Usuario')); ?></li>
                </ul>
            </div>
                        ...
                        <div class="border-b border-slate-200 p-4 dark:border-navy-500 sm:px-5">
                            <div class="flex items-center space-x-2">
                                ...
                                <h4 class="text-lg font-medium text-slate-700 dark:text-navy-100">
                                    <?php echo e(__('Datos del Usuario')); ?>
...
} elseif ($_instance->childHasBeenRendered('pATjIwh')) {
    $componentId = $_instance->getRenderedChildComponentId('pATjIwh');
    $componentTag = $_instance->getRenderedChildComponentTagName('pATjIwh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pATjIwh');
} else {
    $response = \Livewire\Livewire::mount('user-register');
    $html = $response->html();
    $_instance->logRenderedChild('pATjIwh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
