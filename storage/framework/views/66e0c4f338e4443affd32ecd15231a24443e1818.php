    ...
    <?php $__env->startSection('content'); ?>
        <main class="main-content w-full px-[var(--margin-x)] pb-8">
            ...
            <div class="flex items-center space-x-4 py-5 lg:py-6">
                <h2 class="text-xl font-medium text-slate-800 dark:text-navy-50 lg:text-2xl"><?php echo e(__('Registrar Usuario')); ?></h2>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
            ...
            <div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
                <div class="col-span-12 grid lg:col-span-10">
                    <div class="card">
                        ...
                        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('user-register')->html();
} elseif ($_instance->childHasBeenRendered('bFMu4g2')) {
    $componentId = $_instance->getRenderedChildComponentId('bFMu4g2');
    $componentTag = $_instance->getRenderedChildComponentTagName('bFMu4g2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bFMu4g2');
} else {
    $response = \Livewire\Livewire::mount('user-register');
    $html = $response->html();
    $_instance->logRenderedChild('bFMu4g2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
